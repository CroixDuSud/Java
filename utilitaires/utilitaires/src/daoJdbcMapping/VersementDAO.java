...
// --------------------------------------------------------------------------
      ...
      else
      {
         if (rowCount == 0)
         {
            throw new SQLException("Versement " + versement.getNumero() +
                                   " inconnu");
         }
         else
         {
            throw new SQLException("Clef " + versement.getNumero() + " en double !");
         }
      }
   }
...
// --------------------------------------------------------------------------
   public int creer(Versement versement) throws SQLException
   {
      ...
      String chaineDate =
         Conversion.dateSQL(date, base.getFormatDate());
