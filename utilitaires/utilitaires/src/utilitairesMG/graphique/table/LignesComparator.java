...
// --------------------------------------------------------------------------
   public int compare(Object o1, Object o2)
   {
      ...
      if ((o1 instanceof Vector) && (o2 instanceof Vector))
      {
         ...
         {
            if (e2.elementAt(numeroColonne) == null)
            {
               retour = 1;
            }
            else
            {
               if(e1.elementAt(numeroColonne) instanceof String)
               {
                  retour = ((String)e1.elementAt(numeroColonne)).compareToIgnoreCase(
                            (String)e2.elementAt(numeroColonne));
               }
               else
               {
