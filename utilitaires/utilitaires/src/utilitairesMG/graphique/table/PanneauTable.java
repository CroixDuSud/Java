...
// --------------------------------------------------------------------------
            ...
            {
               colonnesSelModele[i] =
                  table.convertColumnIndexToModel(colonnesSelVisibles[i]);
            }
...
// --------------------------------------------------------------------------
            ...
            {
               valeur = ((AbstractRenduCellule)rendu).conversionObjectString(
                         table.getValueAt(i, colSelect));
               ...
               if (valeur != null)
               {
                  ...
                  {
                     case 0 :
                        if(valeur.compareTo(cherchee) == 0) retour = i;
                        break;
                     case 1 :
                        if(valeur.startsWith(cherchee)) retour = i;
                        break;
                     case 2 :
                        if(valeur.contains(cherchee))retour = i;
                        break;
                     default :
                  }
               }
