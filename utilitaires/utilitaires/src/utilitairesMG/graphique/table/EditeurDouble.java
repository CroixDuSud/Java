...
public class EditeurDouble extends DefaultCellEditor
{
...
// --------------------------------------------------------------------------
   ...
   public EditeurDouble(int nombreCaracteres)
   {
      super(new JTextField());
   ...
   public EditeurDouble(int nombreCaracteres, int ndec, int zero)
   {
      super(new JTextField());
      this.nombreCaracteres = nombreCaracteres;
      this.ndec = ndec;
   ...
   public EditeurDouble(int nombreCaracteres,int ndec, int zero, char separ)
   {
      super(new JTextField());
      this.nombreCaracteres = nombreCaracteres;
      this.ndec = ndec;
