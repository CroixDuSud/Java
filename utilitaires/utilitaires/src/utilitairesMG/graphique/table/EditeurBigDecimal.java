...
public class EditeurBigDecimal extends DefaultCellEditor
{
...
// --------------------------------------------------------------------------
   ...
   public EditeurBigDecimal(int nombreCaracteres)
   {
      super(new JTextField());
   ...
   public EditeurBigDecimal(int nombreCaracteres, int ndec, int zero)
   {
      super(new JTextField());
      this.nombreCaracteres = nombreCaracteres;
      this.ndec = ndec;
   ...
   public EditeurBigDecimal(int nombreCaracteres, int ndec, int zero, char separ)
   {
      super(new JTextField());
      this.nombreCaracteres = nombreCaracteres;
      this.ndec = ndec;
