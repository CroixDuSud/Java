...
// fait dans la classe Fenetre par les Thread animation.
// ==========================================================================
...
// --------------------------------------------------------------------------
      BufferedImage img2 = 
         new BufferedImage(taille.width, taille.height, BufferedImage.TYPE_INT_ARGB);
...
// Couleur de fond 
// --------------------------------------------------------------------------
      g2.setBackground(new Color(255, 0, 255, 0));
...
// --------------------------------------------------------------------------
      AffineTransform at = AffineTransform.getTranslateInstance(taille.width/2, taille.height/2);
