...
public class EditeurObject extends DefaultCellEditor
{
...
// --------------------------------------------------------------------------
   public EditeurObject(int nombreCaracteres)
   {
...
// --------------------------------------------------------------------------
                                                ...
                                                int column)
   {
      ...
      {
         zoneTexte.setDocument(new DocumentSaisieLimitee(nombreCaracteres, (String)value));
      }
