// ==========================================================================
// Classe ModeleColonneTable                              TestsCompletsTables
// ==========================================================================
...
// --------------------------------------------------------------------------
         if(typeColonne.compareTo("java.util.Date") == 0)
         {
            ...
            colonne.setCellEditor(
               new EditeurDate(nombreCaracteresColonne));
         }
...
// --------------------------------------------------------------------------
         if(typeColonne.compareTo("java.lang.Float") == 0)
         {
            ...
            colonne.setCellEditor(
               new EditeurFloat(nombreCaracteresColonne));
         }
...
// --------------------------------------------------------------------------
         if(typeColonne.compareTo("java.lang.Double") == 0)
         {
            ...
            colonne.setCellEditor(
               new EditeurDouble(nombreCaracteresColonne));
         }
...
// --------------------------------------------------------------------------
         if(typeColonne.compareTo("java.math.BigDecimal") == 0)
         {
            ...
            colonne.setCellEditor(
               new EditeurBigDecimal(nombreCaracteresColonne));
         }
...
// --------------------------------------------------------------------------
         if(typeColonne.compareTo("java.lang.Integer") == 0)
         {
            ...
            colonne.setCellEditor(
               new EditeurInteger(nombreCaracteresColonne));
         }
...
// --------------------------------------------------------------------------
         if(typeColonne.compareTo("java.lang.Long") == 0)
         {
            ...
            colonne.setCellEditor(
               new EditeurLong(nombreCaracteresColonne));
         }
...
// --------------------------------------------------------------------------
         if(typeColonne.compareTo("java.lang.String") == 0)
         {
            ...
            colonne.setCellEditor(new EditeurObject(nombreCaracteresColonne));
         }
...
// --------------------------------------------------------------------------
   public void setNombreCaracteresMax(int nombreCaracteresMax)
   {
      ...
      int nombreColonnes = listeColonnes.size();
      for(int c = 0; c < nombreColonnes; c++)
      {
         int nombreCaracteresAff = listeColonnes.elementAt(c).getLongueur();
         ...
         setTailleColonne(c, nombreCaracteresAff);
      }
   }
