...
public class EditeurFloat extends DefaultCellEditor
{
...
// --------------------------------------------------------------------------
   ...
   public EditeurFloat(int nombreCaracteres)
   {
      super(new JTextField());
   ...
   public EditeurFloat(int nombreCaracteres, int ndec, int zero)
   {
      super(new JTextField());
      this.nombreCaracteres = nombreCaracteres;
      this.ndec = ndec;
   ...
   public EditeurFloat(int nombreCaracteres, int ndec, int zero, char separ)
   {
      super(new JTextField());
      this.nombreCaracteres = nombreCaracteres;
      this.ndec = ndec;
