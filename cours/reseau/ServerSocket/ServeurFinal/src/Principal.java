...
// --------------------------------------------------------------------------
// Serveur est une classe de type Thread. L'instanciation est faite dans le
// Thread main. Ce n'est qu'a partir du start() que le nouveau Thread 
// demarre.
// --------------------------------------------------------------------------
        serveur = new ServeurFinal();
        serveur.start();
