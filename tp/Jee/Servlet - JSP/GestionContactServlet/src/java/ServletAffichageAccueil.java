...
// --------------------------------------------------------------------------
         affiche +=       "<div class=\"divRadio\">";
            checked = false;
            if (choixAction.compareTo("modification") == 0) checked = true;
            ...
            checked = false;
            if (choixAction.compareTo("creation") == 0) checked = true;
            ...
            checked = false;
            if (choixAction.compareTo("suppression") == 0) checked = true;
         ...
         affiche += "<br />";
            ...
            checked = false;
            if (choixAction.compareTo("liste") == 0) checked = true;
