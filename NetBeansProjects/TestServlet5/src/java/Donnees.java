...
// --------------------------------------------------------------------------
// Ecriture des attributs dans des objet Cookie
// Les noms des parametres crees (nomUtil, motPasseUtil) sont identiques a
// ceux des parametres recus... Mais ce sont deux nouvelles informations !
// --------------------------------------------------------------------------
      cookNomUtil = new Cookie("nomUtil", nomUtil);
      cookMotPasseUtil = new Cookie("motPasseUtil", motPasseUtil);
      reponse.addCookie(cookNomUtil);
      reponse.addCookie(cookMotPasseUtil);
