// ==========================================================================
// ServletDonnees.java : servlet du projet testServlet2
// --------------------------------------------------------------------------
// Recuperation des parametres saisis sur l'ecran donnees.html
// Affichage de ces donnees et de celles de index.jsp recuperee dans le
// ServletContext
// ==========================================================================
...
// --------------------------------------------------------------------------
// Lecture des parametres stockes dans les attributs de ServletContext
// --------------------------------------------------------------------------
         contexte = getServletContext();
         nomUtil = (String)contexte.getAttribute("nomUtil");
         motPasseUtil = (String)contexte.getAttribute("motPasseUtil");
