...
// ==========================================================================
package gestioncontactreseau;

import daoServeurJdbcMapping.ContactDAO;
import daoServeurJdbcMapping.PriseServeurJdbc;
import daoServeurJdbcMapping.SecteurDAO;
import daoServeurJdbcMapping.VersementDAO;
import java.util.*;
...
// --------------------------------------------------------------------------
        ...
        versementDAO = new VersementDAO(priseServeur);
...
// --------------------------------------------------------------------------
// 2. Sauvegarde du vecteur des Contacts inseres dans la priseServeur de donnees.
// --------------------------------------------------------------------------
...
// --------------------------------------------------------------------------
// 3. Sauvegarde du vecteur des Contacts modifies dans la priseServeur de donnees.
// --------------------------------------------------------------------------
